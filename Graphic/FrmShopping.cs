...
namespace Graphic
{
    ...
    {
        public FrmShopping(string teme)
        {
            InitializeComponent();
            TemeChange(teme);
        }
        ...
        {
            Guna.UI2.WinForms.Guna2Panel[] mainColor = { pnlDataConteiner, pnlTopList };

            Guna.UI2.WinForms.Guna2Panel[] conteinerColor = {pnlButtonConteiner, pnlDataBackgroundScndLayer };

            Label[] labelsForeColor = {  };
            Guna.UI2.WinForms.Guna2Button[] buttonsForeColor = { btnClean, btnSubmit };
        ...
        private void pnlDataConteiner_Paint(object sender, PaintEventArgs e)
        {
